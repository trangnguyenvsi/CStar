...
public class AddScreeningData {
	@DataProvider(name="Choose setup screening kind")
	public static Object[][] chooseSetupScreeningKind() {
		Object[][] data = ExcelHandle.getTable("./data/AddScreening.xlsx", "AddScreening", "TS01");
		return data;
	}
	
	@DataProvider(name="VerifyZipCode")
	public static Object[][] verifyZipcode() {
		Object[][] data = ExcelHandle.getTable("./data/AddScreening.xlsx", "AddScreening", "TS09");
		return data;
	}
	
	@DataProvider(name="Existing Site")
	public static Object[][] existingSite() {
		Object[][] data = ExcelHandle.getTable("./data/AddScreening.xlsx", "AddScreening", "TS10");
		return data;
	}
	
	@DataProvider(name="Validation Address")
	public static Object[][] validationAddress() {
		Object[][] data = ExcelHandle.getTable("./data/AddScreening.xlsx", "AddScreening", "TS12");
		return data;
	}
	
	@DataProvider(name="CreateNewSite")
	public static Object[][] takeappointment() {
		Object[][] data = ExcelHandle.getTable("./data/AddScreening.xlsx", "AddScreening", "TS13");
		return data;
	}
	
	@DataProvider(name="ACO Type Verification")
	public static Object[][] verifyACOTypeDropdown() {
		Object[][] data = ExcelHandle.getTable("./data/AddScreening.xlsx", "AddScreening", "TS14");
		return data;
	}
	
	@DataProvider(name="ScreeningInfoData")
	public static Object[][] takeappointment3() {
		Object[][] data = ExcelHandle.getTable("./data/AddScreening.xlsx", "AddScreening", "TS15");
		return data;
	}
//	
